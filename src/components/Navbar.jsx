...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-black' >
        ...
        <li className="p-4 navbar-links" style={{ whiteSpace: 'nowrap' }}>À propos</li>
        <li className="p-4 navbar-links" style={{ whiteSpace: 'nowrap' }}>Nos produits</li>
          ...
          <li className="p-4 navbar-links">Contact</li>
        </ul>
        <div onClick={handleNav} className='block md:hidden'>
          {!nav ? <AiOutlineClose size={30}/> : <AiOutlineMenu size={30}/>}
        </div>
        <div className={!nav ? "fixed left-0 top-0 w-[60%] border-r h-full border-r-gray-900 text-white bg-[#191A19] ease-in-out duration-500" : "fixed hidden"}>
        <h1 className='w-full text-3xl pt-2 font-bold text-[#ffffff] m-4'>TuniLift</h1>
          <ul className='p-4'>
            <li className="p-4 sidebar border-b border-gray-600" style={{ whiteSpace: 'nowrap' }}>À propos</li>
